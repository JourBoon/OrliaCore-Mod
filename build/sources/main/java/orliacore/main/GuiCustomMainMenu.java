...
public class GuiCustomMainMenu extends GuiScreen
{
    ...
    private static final ResourceLocation MFF_TITLE = new ResourceLocation(ModOrliaCore.MODID, "textures/gui/orlia_mc3.png");
    private static final ResourceLocation field_194400_H = new ResourceLocation("textures/gui/title/edition.png");
    /** An array of all the paths to the panorama pictures. */
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(ModOrliaCore.MODID, "textures/gui/2.png");
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 280, j + 72 + 168, 98, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 180, j + 72 + 168, 98, 20, I18n.format("menu.quit")));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 10, j + 72 + 12));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
    	...
    	this.buttonList.add(new GuiButton(20, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("Login")));
    	//int j = 4 + 48;
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
    	...
    	if(button.id == 20) {
    		FMLClientHandler.instance().connectToServer(this, new ServerData("OrliaMC", "game03-dc2.ouiheberg.com:10176", false));
    	}
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        //GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        //Gui.drawScaledCustomSizeModalRect(this.width / 2 - 50, 50, 0, 0, 1, 1, 100, 100, 1, 1);
